 ...
 */
function getPost(int|WP_Post|null $post = null): ?WP_Post
{
 ...
 */
function getTerm(int|object $term, string $taxonomy = ''): ?WP_Term
{
 ...
 */
function getTermBy(string $field, int|string $value, string $taxonomy = ''): ?WP_Term
{
 ...
 */
function getComment(WP_Comment|int $comment): ?WP_Comment
{
 ...
 */
function getUser(WP_User|int $user): ?WP_User
{
 ...
 */
function getUserBy(string $field, int|string $value): ?WP_User
{
 ...
 */
function getSite(WP_Site|int|null $site = null): ?WP_Site
{
 ...
 */
function getTaxonomy(string $name): ?WP_Taxonomy
{
